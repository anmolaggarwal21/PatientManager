using DeviceManager.ConstantClasses;
...
{
    public class BillingDetailsBase : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        private bool FilterFunc(BillingEntityDto element, string searchString)
        {
            ...
            if (element.PatientName.Contains(searchString, StringComparison.OrdinalIgnoreCase))
                return true;
            if (element.AdmissionDate!.Contains(searchString, StringComparison.OrdinalIgnoreCase))
                return true;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if(list != null && list.Count > 0)
            {
                ...
                {
                    BillingEntityDto.Add(new Entities.BillingEntityDto()
                    {
                        AdmissionDate = item.AdmissionDate!.Value.Date.ToString("MM-dd-yyyy"),
